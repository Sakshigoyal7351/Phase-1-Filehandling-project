...
public class project1 {
	...
	public static void main(String[] args) {
		...
		File directory = new File("C://Users//LENOVO//Desktop//filehandling");
		...
		do {
			...
			case 3:
				...
				File directory_delete = new File("C://Users//LENOVO//Desktop//simplilearn//FileCreation");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"C://Users//LENOVO//Desktop//simplilearn//FileCreation//" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("C://Users//LENOVO//Desktop//simplilearn//FileCreation//");
...
//	}
	...
	private static void listOfFiles() {
		...
		File folder = new File("C://Users//LENOVO//Desktop//simplilearn//FileCreation//");
